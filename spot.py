...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id="4e7b220ab55e4887a6f275a639cd08a7",
                                                           client_secret="a181a5078b0143b5a43d7f7e2883497f"))
...
if __name__ == "__main__":
    ...
    final_list = songs_by_emotion('happy') #Input Emotion
